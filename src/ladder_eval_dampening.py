...
Run: PYTHONHASHSEED=0 python3 -B ladder_eval_dampening.py <final.pt> <out.json> <expected_strength>

LADDER VARIANT: derived from the official phase4_endpoint_eval.py with ONE functional
