#!/bin/bash
# Batch 1 remaining: 10 runs in waves of 4 on GPU
# Stagger launches by 90s to avoid simultaneous torch.compile RAM spikes
# Picks up after true_s456 and wrong_s456 complete
...
echo "=== Batch 1 remaining: 10 runs (staggered 4-at-a-time on GPU) ==="
...
PID1=$!
sleep 90  # let first process pass torch.compile
ram_check
...
# --- Wave B: random_s42, random_s123, random_s456, uniform_s42 ---
echo ""
...
# --- Wave C: uniform_s123, uniform_s456 ---
echo ""
echo "=== Wave C (2 runs, staggered) — $(date) ==="
...
# Verify all 12 checkpoints (including the earlier true_s456/wrong_s456)
echo ""
